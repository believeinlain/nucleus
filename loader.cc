...
const char *binary_arch_descr[][2] = {
    ...
    {"riscv", "riscv: Experiment from RN to add arch."},
    {NULL, NULL}};
...
int load_dynrelocs_bfd(bfd *bfd_h, Binary *bin)
{
  ...
  asection *bfd_sec; // need asection for new api to bfd
